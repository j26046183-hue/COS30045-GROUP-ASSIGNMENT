...
function drawDrugDonut(data) {
    ...
    // rigid square boundaries to keep it perfectly symmetrical
    const width = container.offsetWidth;
    const height = 320; // Locks height matching  layout cards perfectly
    ...
    chartG.append("text").attr("text-anchor", "middle").attr("dy", "-0.2em")
        ...
        .attr("font-family", "Syne, sans-serif").attr("fill", "#ffffff")

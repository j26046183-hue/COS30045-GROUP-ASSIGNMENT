...
const stateMargin = { top: 20, right: 80, bottom: 40, left: 60 };
...
// Create tooltip
const stateTooltip = d3.select("body").append("div").attr("class", "tooltip");
...
// Load data
d3.csv("data/finesbystate.csv").then(function(data) {
...
d3.select("#state-offence-filter").on("change", function() {
    // Placeholder for future filter logic
    // Will update when fines_by_metric data is integrated

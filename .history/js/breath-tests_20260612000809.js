...
// BREATH-TESTS.JS
// 3 Charts:
// 1. Historical Line Chart   — breath_historical_trend.csv (2008–2024, all states)
// 2. Regional Donut Chart    — breath_2023_2024.csv (ACT, NSW, VIC only — location breakdown)
// 3. Age Group Bar Chart     — breath_2023_2024.csv (ACT, NSW, VIC only — age breakdown)
//
// Data notes:
// - breath_historical_trend.csv: YEAR, STATE, TOTAL FINES, TOTAL CHARGES, TOTAL ARRESTS, COUNT
// - breath_2023_2024.csv: YEAR, STATE, LOCATION, AGE_GROUP, TOTAL FINES, TOTAL CHARGES, TOTAL ARRESTS, COUNT
//   Only ACT, NSW, VIC have location/age breakdown. NT/QLD/SA/TAS/WA not in this file.
// =====================

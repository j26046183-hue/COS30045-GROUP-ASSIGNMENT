...
const regionalColors = {
    ...
    "All regions":                "#64748b" // Added fallback color block just in case TAS rows use this
};
...
// ══════════════════════════════════════════
// CHART 1: HISTORICAL LINE CHART (Fixed Line Isolation)
// ══════════════════════════════════════════
function drawBreathHistorical(data) {
    d3.select("#breath-historical-chart").selectAll("*").remove();
    if (!data || data.length === 0) return;

    // FIX: Instead of rejecting rows based on location string filtering, we bundle counts directly 
    // by state and year. This makes sure your manually appended TAS data traces automatically.
...
// ══════════════════════════════════════════
// CHART 2: REGIONAL DONUT CHART (Handles Fallbacks)
// ══════════════════════════════════════════
...
// ══════════════════════════════════════════
// CHART 3: AGE GROUP BAR CHART (Accepts Group Fallbacks)
// ══════════════════════════════════════════

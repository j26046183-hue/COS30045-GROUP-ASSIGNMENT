...
function applyFinesFilters() {
    ...
    //  State chart: offence filter only — always shows all 8 states ──
    ...
    // ── Age: both filters — all 8 states always have 17-25 to 65+ ──
    ...
    // ── Location: both filters — Unknown renamed so always shows ──
